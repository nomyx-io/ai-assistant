...
create_util("logOutput", "Logs a message to the console.", \`Console log the provided message.\`);
    ...
    tools: {
        set_logic: async ({ logic }, state) => {
            state.talkdown.logic = logic;
            return `Pseudocode logic set to: ${logic}`;
        },
        create_process: async ({ name, description, steps }, state) => {
        ...
        create_directive: async ({ name, description, parameters, actions }, state) => {
        ...
        create_function: async ({ name, description, inputs, outputs, logic }, state) => {
        ...
        create_util: async ({ name, description, logic }, state) => {
...
//# sourceMappingURL=talkdown.js.map
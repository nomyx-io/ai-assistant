...
module.exports = {
    ...
    tools: {
        "get-file-tree": {
            ...
            action: ({ path, n }) => __awaiter(void 0, void 0, void 0, function* () {
                try {
        ...
        "file": {
            ...
            action: ({ operation, path, match, data, position, target }, { thread }, assistantAPI) => __awaiter(void 0, void 0, void 0, function* () {
                const fs = require('fs');
                const pathModule = require('path');
                const cwd = process.cwd();
                try {
                    ...
                    switch (operation) {
                        ...
                        case 'copy':
                            ...
                            break;
                        case 'attach':
                            yield (({ path }, { assistant }, api) => __awaiter(void 0, void 0, void 0, function* () {
                            ...
                            break;
                        case 'list_attached':
                            yield ((_dummy, assistant) => __awaiter(void 0, void 0, void 0, function* () {
                                try {
                                    if (!assistant) {

...
function gdelt_project_query(term, start_date, // YYYYMMDDHHMMSS
...
function search_gdelt(term, options) {
    return __awaiter(this, void 0, void 0, function* () {
...
module.exports = {
    ...
    tools: {
        search_GDELT: ({ term, start_date, end_date, max_records, format }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const results = yield search_gdelt(term, { start_date, end_date, max_records, format });
